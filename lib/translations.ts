...
const translations = {
  ...
  pitch_not_started:      { EN: 'Yet to play',              KU: 'هێشتا یاری نەکراوە' },
  ...
  matches_completed_label: { EN: 'Matches completed',        KU: 'یاری تەواوبووە' },
  matches_remaining_label: { EN: 'Matches remaining',        KU: 'یاری ماوە' },
  captain_status_pending:  { EN: 'Captain has not played yet -- captain bonus not yet applied.', KU: 'کاپتن هێشتا یاری نەکردووە -- خاڵی دووبارەکردنەوە هێشتا جێبەجێ نەکراوە.' },
  captain_status_dnp_vice_applied: { EN: 'Captain did not play -- vice-captain bonus applied provisionally.', KU: 'کاپتن یاری نەکرد -- خاڵی جێگری کاپتن بە شێوەیەکی کاتیی جێبەجێکرا.' },
  captain_status_dnp_vice_pending: { EN: 'Captain did not play; vice-captain has not played yet -- pending.', KU: 'کاپتن یاری نەکرد؛ جێگری کاپتنیش هێشتا یاری نەکردووە -- چاوەڕوانە.' },
  autosub_review_pending:  { EN: 'One or more starters did not play -- automatic-substitution review is pending official finalization.', KU: 'یەک یان زیاتر لە یاریزانانی سەرەکی یاریان نەکرد -- پێداچوونەوەی گۆڕینی خۆکار چاوەڕوانی کۆتایی فەرمییە.' },
  final_evaluation_deferred: { EN: 'Final evaluation (autosubs, captain fallback, manager-state advance) is deferred until the gameweek is officially finalized.', KU: 'هەڵسەنگاندنی کۆتایی (گۆڕینی خۆکار، جێگری کاپتن، پێشکەوتنی دۆخی بەڕێوەبەر) دواخراوە هەتا هەفتەکە بە فەرمی کۆتایی پێبهێنرێت.' },
  refresh_now_button:      { EN: 'Refresh now',              KU: 'ئێستا نوێبکەرەوە' },
