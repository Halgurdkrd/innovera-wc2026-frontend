...
const translations = {
  ...
  // ── Release model: forecast status and results status are INDEPENDENT ─────
  // (forecast never changes when matches start; results move on their own).
  release_forecast_label:    { EN: 'Forecast',                     KU: 'پێشبینی' },
  release_results_label:     { EN: 'Results',                      KU: 'ئەنجامەکان' },
  ...
  release_results_in_progress: { EN: 'In progress',                 KU: 'لە یاریدایە' },
  release_results_provisional: { EN: 'Gameweek matches complete -- points provisional', KU: 'یارییەکانی هەفتەکە تەواوبوون -- خاڵەکان کاتیین' },
  release_results_final:     { EN: 'Final',                        KU: 'کۆتایی' },
  release_results_not_tracked: { EN: 'No results scored for this release', KU: 'هیچ ئەنجامێک بۆ ئەم بڵاوکردنەوەیە تۆمار نەکراوە' },
  release_results_updated:   { EN: 'Results updated {time}',       KU: 'ئەنجامەکان نوێکرانەوە: {time}' },
  release_results_stale:     { EN: 'Results may be out of date -- the last successful update was {time}.', KU: 'ئەنجامەکان لەوانەیە کۆن بن -- دوایین نوێکردنەوەی سەرکەوتوو {time} بوو.' },
  release_results_stale_unknown: { EN: 'Results may be out of date -- the latest refresh did not succeed.', KU: 'ئەنجامەکان لەوانەیە کۆن بن -- دوایین نوێکردنەوە سەرکەوتوو نەبوو.' },
  release_swapped_to_final:  { EN: 'Updated to the final frozen forecast', KU: 'نوێکرایەوە بۆ پێشبینی کۆتایی جێگیرکراو' },
  release_swapped_generic:   { EN: 'Updated to the latest release', KU: 'نوێکرایەوە بۆ دوایین بڵاوکردنەوە' },
  release_frozen_xp_label:   { EN: 'Frozen expected points (forecast)', KU: 'خاڵی پێشبینیکراوی جێگیرکراو (پێشبینی)' },
  release_actual_label:      { EN: 'Actual points so far',         KU: 'خاڵی ڕاستەقینەی هەتا ئێستا' },
  release_actual_final_label: { EN: 'Final actual points',         KU: 'خاڵی ڕاستەقینەی کۆتایی' },
  release_no_results_note:   { EN: 'This is an early forecast: no actual points are scored against it.', KU: 'ئەمە پێشبینییەکی زووە: هیچ خاڵێکی ڕاستەقینە لەگەڵیدا هەڵناسەنگێندرێت.' },
  release_provisional_legend: { EN: '* Provisional -- bonus points and official checks may still change this player\'s points.', KU: '* کاتیی -- خاڵی بۆنس و پشکنینی فەرمی لەوانەیە هێشتا خاڵی ئەم یاریزانە بگۆڕن.' },
  release_yet_to_play:       { EN: 'Yet to play',                  KU: 'هێشتا یاری نەکردووە' },
  release_no_data:           { EN: 'No data',                      KU: 'داتا نییە' },
  release_no_data_title:     { EN: 'Official data for this player is missing -- this is not a zero.', KU: 'داتای فەرمی ئەم یاریزانە بەردەست نییە -- ئەمە سفر نییە.' },
  release_provisional_bonus: { EN: 'Provisional -- bonus points may still change', KU: 'کاتیی -- خاڵی بۆنس لەوانەیە هێشتا بگۆڕێت' },
  release_reconciliation:    { EN: 'XI raw {xi} + captain/vice extra {cap} + autosub {auto} - hits {hit} = {total}', KU: 'کۆی خاوی یاریی سەرەکی {xi} + زیادەی کاپتن/جێگر {cap} + گۆڕینی خۆکار {auto} - سزا {hit} = {total}' },
  release_reconciliation_mismatch: { EN: 'The components above do not add up to the reported total -- treat this figure with caution.', KU: 'بەشەکانی سەرەوە بە کۆی ڕاگەیێندراو ناگەنەوە -- بە ئاگاداریەوە مامەڵە لەگەڵ ئەم ژمارەیە بکە.' },
  release_yet_to_play_list:  { EN: 'Yet to play',                  KU: 'هێشتا یاریان نەکردووە' },
  release_pending_adjustments: { EN: 'Pending adjustments',         KU: 'ڕێکخستنە چاوەڕوانکراوەکان' },
  release_autosub_PENDING_UNRESOLVED_FIXTURES: { EN: 'Automatic substitutions: pending -- some fixtures are unresolved.', KU: 'گۆڕینی خۆکار: چاوەڕوانە -- هەندێک یاری هێشتا یەکلا نەبوونەتەوە.' },
  release_autosub_NOT_APPLICABLE_XI_ONLY: { EN: 'Automatic substitutions: not applicable (this is an XI-only object with no bench).', KU: 'گۆڕینی خۆکار: پەیوەست نییە (ئەم بژاردەیە تەنها یاریی سەرەکییە و یەدەگی نییە).' },
  release_autosub_APPLIED_PROVISIONAL: { EN: 'Automatic substitutions applied (provisional).', KU: 'گۆڕینی خۆکار جێبەجێکرا (کاتیی).' },
  release_autosub_APPLIED_FINAL: { EN: 'Automatic substitutions applied (final).', KU: 'گۆڕینی خۆکار جێبەجێکرا (کۆتایی).' },
  release_autosub_NONE_NEEDED: { EN: 'Automatic substitutions: none needed.', KU: 'گۆڕینی خۆکار: پێویست نەبوو.' },
  release_notice_FINAL_NOT_REGISTERED_DEADLINE_PASSED: { EN: 'The deadline has passed and no final frozen forecast was registered for this gameweek. This page shows the last early forecast, generated {time}.', KU: 'کاتی کۆتایی تێپەڕیوە و هیچ پێشبینییەکی کۆتایی جێگیرکراو بۆ ئەم هەفتەیە تۆمار نەکراوە. ئەم پەڕەیە دوایین پێشبینی زوو پیشان دەدات کە لە {time} دروستکراوە.' },
  release_notice_EARLY_FORECAST_STALE: { EN: 'This early forecast has not been refreshed recently (last successful update {time}) and may be out of date.', KU: 'ئەم پێشبینییە زووە بەم دواییە نوێنەکراوەتەوە (دوایین نوێکردنەوەی سەرکەوتوو {time}) و لەوانەیە کۆن بێت.' },
  release_notice_RESULTS_STALE: { EN: 'Live results could not be refreshed recently; the points shown were last updated {time}.', KU: 'ئەنجامەکان بەم دواییە نەتوانرا نوێبکرێنەوە؛ خاڵە پیشاندراوەکان دوایین جار لە {time} نوێکراونەتەوە.' },
  release_notice_MATCHES_COMPLETE_POINTS_PROVISIONAL: { EN: 'All gameweek matches are complete, but points are still provisional until official confirmation (bonus points and corrections).', KU: 'هەموو یارییەکانی هەفتەکە تەواوبوون، بەڵام خاڵەکان هێشتا کاتیین هەتا پشتڕاستکردنەوەی فەرمی (خاڵی بۆنس و ڕاستکردنەوەکان).' },
  release_notice_FINAL_REGISTRATION_PENDING_PUBLICATION: { EN: 'The final frozen forecast has been registered and is being published; this page will update automatically.', KU: 'پێشبینی کۆتایی جێگیرکراو تۆمارکراوە و بڵاودەکرێتەوە؛ ئەم پەڕەیە بەشێوەی خۆکار نوێ دەبێتەوە.' },
  release_notice_RESULTS_NOT_SCORED_AGAINST_EARLY_FORECAST: { EN: 'Official fixture results are shown, but points are not scored against an early forecast that was never registered as a final frozen forecast.', KU: 'ئەنجامی فەرمیی یارییەکان پیشان دەدرێن، بەڵام خاڵ بەراورد ناکرێت لەگەڵ پێشبینییەکی زوو کە هەرگیز وەک پێشبینی کۆتایی جێگیرکراو تۆمار نەکراوە.' },
  release_fixtures_progress: { EN: 'Fixtures: {done}/{total} finished, {live} in progress', KU: 'یاری: {done}/{total} تەواوبووە، {live} بەردەوامە' },
